              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@pgfinder.com</p>
                    <p className="text-gray-600">info@pgfinder.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="mb-6">
                ...
                <div className="flex space-x-3">
                  <button className="w-10 h-10 bg-blue-600 rounded flex items-center justify-center hover:bg-blue-700 transition-colors">
                    <svg
                      className="w-5 h-5 text-white"
                      fill="currentColor"
                      viewBox="0 0 24 24"
